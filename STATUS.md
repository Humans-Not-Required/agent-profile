...
**Version:** 0.3.0   (backend skeleton)
...
- Manage token auth (SHA-256 hashed)
- HTML profile page at `/agents/{slug}` (dark-mode card, responsive)
- CORS fairing (`Access-Control-Allow-Origin/Methods/Headers`, preflight)
- OpenAPI 3.1.0 spec (`openapi.json`)
- GitHub Actions CI + Docker image (`ghcr.io/humans-not-required/agent-profile:dev`)
- **37 passing tests** (4 unit + 33 integration incl. HTML + CORS)
