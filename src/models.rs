...
pub const VALID_THEMES: &[&str] = &[
    ...
    "newyear", "valentine", "patriot", "boba", "fruitsalad",
];
pub const VALID_PARTICLE_EFFECTS: &[&str] = &["none", "snow", "leaves", "rain", "fireflies", "stars", "sakura", "embers", "digital-rain", "flames", "water", "boba", "clouds", "fruit"];
